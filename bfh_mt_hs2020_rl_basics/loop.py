...
class LoopControl:
    def __init__(self, bridge:Bridge, run_name:str, bound_avg_reward:float=1000.0):
        ...
        EndOfEpisodeHandler(self.bridge.agent.exp_source, bound_avg_reward).attach(self.engine)
